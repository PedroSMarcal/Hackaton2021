...
def getEspecificOccurrence(id):
    try:
        ...
        response = {
            ...
            'obs': occurrence.obs, 'proper': occurrence.proper, 
            'cellphone': occurrence.cellphone, 
            'active': occurrence.active, 
            'latitude': occurrence.latitude, 
            'longitude': occurrence.longitude, 
            'occurrenceNumber': occurrence.occurrenceNumber, 
            'status_ocorrence': occurrence.status_ocorrence, 
            'citizenOcurrence': occurrence.citizenOcurrence, 
...
def getAllOccurrence():
    try:
        ...
        response = [{
            ...
            'obs': i.obs, 'proper': i.proper, 
            'cellphone': i.cellphone, 
            'active': i.active, 
            'latitude': i.latitude, 
            'longitude': i.longitude, 
            'occurrenceNumber': i.occurrenceNumber, 
            'status_ocorrence': i.status_ocorrence, 
            'citizenOcurrence': i.citizenOcurrence, 
            'problem': i.problem
            } for i in occurrence]
    except:
